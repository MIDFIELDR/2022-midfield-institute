...
``` r
packages_we_use <- c("data.table", "ggplot2", "checkmate", "wrapr")
...
On Tuesday, August 2---the day before the Institute---we plan to hold online office hours to answer your questions about MIDFIELD and help resolve any problems you might be having using R or midfieldr. See the [Agenda](agenda.html) for more information. 
