...
The MIDFIELD Institute is a hands-on workshop that helps participants explore using the Multiple-Institution Database for Investigating Longitudinal Development (MIDFIELD).  In August 2022, the Institute will be an all-virtual meeting over several days.
...
MIDFIELD is a partnership of higher education institutions with engineering programs. Begun in 2004 as an extension of the SUCCEED Longitudinal Database, MIDFIELD contains Student Unit Record (SUR) data for all undergraduate, degree-seeking students at the partner institutions. 
...
: Graduate Research Assistant and PhD student in Engineering Education at Purdue University. She focused on utilizing and applying quantitative approaches to multi-institutional data using R. (hmosman@purdue.edu)


David Waller

: PhD candidate in Engineering Education at Purdue University. David has extensive experience working with institutional data in R and his research focuses on measuring organizational features of engineering majors. (wallerd@purdue.edu)
