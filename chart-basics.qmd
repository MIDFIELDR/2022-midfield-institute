...
[First plot.]{.important} Let’s plot the weight data (y axis) as a function of time (x axis). The first plot is empty because there is no "geom" (a geometric object) to encode the data visually. 
